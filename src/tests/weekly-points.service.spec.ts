...
describe("WeeklyPointsService", () => {
  ...
  describe("processUserPoints", () => {
    ...
    it("should handle failure and update failed count", async () => {
      ...
      mockBotService.sendWeeklyPointsEvent.mockRejectedValueOnce(
  ...
  describe("BotService integration", () => {
    ...
    it("should handle BotService errors gracefully", async () => {
      ...
      mockBotService.getAllUsers.mockRejectedValueOnce(
        new Error("Bot API is unavailable")
      );
  ...
  describe("real API integration", () => {
    it("should use real API when environment variable is set", async () => {
      ...
      if (!process.env.USE_BOT_API_FOR_TESTING) {
        console.log(
          "Skipping real API test. Set USE_BOT_API_FOR_TESTING=true to run it."
        );
        return;
      }
      ...
      const serviceWithRealAPI =
        moduleRef.get<WeeklyPointsService>(WeeklyPointsService);
      ...
      try {
        ...
        console.log(
          `Real API test: Found ${timezoneGroups.size} timezone groups`
        );
        ...
        if (
          ...
          console.log(
            "Authentication failed - check BOT_SECRET_KEY environment variable"
          );
        }
